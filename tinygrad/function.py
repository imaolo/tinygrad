...
@overload
def function(fxn:Callable[..., ReturnType], *, precompile:bool=False, rematerialize:bool=False) -> _function[ReturnType]: ...
@overload
def function(fxn:None=None, *, precompile:bool=False, rematerialize:bool=False) -> Callable[[Callable[..., ReturnType]], _function[ReturnType]]: ...
