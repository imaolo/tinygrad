...
class _function(Generic[ReturnType]):
  def __init__(self, fxn:Callable[..., ReturnType], *, precompile:bool=False, allow_implicit:bool=True, grad_fxn:Callable|None=None, rematerialize:bool=False):
    self.fxn = fxn
  ...
  def __call__(self, *args, **kwargs) -> ReturnType:
    ...
    fret = uret.call(*call_uops, grad_fxn=self.grad_fxn, name=name, precompile=self.precompile, rematerialize=self.rematerialize)
...
def function(fxn:Callable[..., ReturnType], *, precompile:bool=False, allow_implicit:bool=True,
             rematerialize:bool=False, grad_fxn:Callable|None=None) -> _function[ReturnType]: ...
@overload
