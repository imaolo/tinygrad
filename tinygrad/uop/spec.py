...
shared_codegen_spec = PatternMatcher([
  ...
  (UPat(Ops.INDEX, src=(UPat(Ops.CAST, src=(UPat(GroupOp.Defines|{Ops.AFTER}, name="buf"),)), UPat.var("idx"))), validate_index),
  (UPat(Ops.INDEX, src=(UPat(Ops.CAST, src=(UPat(GroupOp.Defines|{Ops.AFTER}, name="buf"),)), UPat.var("idx"), UPat.var("gate", dtype=dtypes.bool))), validate_index),
