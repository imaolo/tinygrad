...
SPLIT_REDUCEOP, MEMORY_PLANNER, LRU = ContextVar("SPLIT_REDUCEOP", 1), ContextVar("MEMORY_PLANNER", 1), ContextVar("LRU", 1)
...
class GlobalCounters:
  ...
  def reset_peak():
    ...
    GlobalCounters.peak_mem_used_per_device = defaultdict(int, GlobalCounters.mem_used_per_device)
